...
void mainRender()
{
	...
	GLuint widthID = glGetUniformLocation(g_glslProgram2DQuad, "width");
	glUniform1i(widthID, g_W);

	GLuint heightID = glGetUniformLocation(g_glslProgram2DQuad, "height");
	glUniform1i(heightID, g_H);
...
void createGeometry()
{
	...
	glGenVertexArrays(1, &VertexArrayID_Dragon);
	glBindVertexArray(VertexArrayID_Dragon);
	...
	g_vertex_buffer_data[2] = 1.f; g_vertex_buffer_data[3] = -1.0f; 
	g_vertex_buffer_data[4] = 1.f; g_vertex_buffer_data[5] = 1.f; 
	//top left triangle
	g_vertex_buffer_data[6] = -1.0f; g_vertex_buffer_data[7] = -1.0f; 
	g_vertex_buffer_data[8] = 1.f; g_vertex_buffer_data[9] = 1.f; 
	g_vertex_buffer_data[10] = -1.0f; g_vertex_buffer_data[11] = 1.f; 
...
void cleanUp()
{
	...
	glDeleteVertexArrays(1, &VertexArrayID_Dragon);
...
#endif
	// create main window
	g_MainWindow=glutCreateWindow("Line Drawing");
